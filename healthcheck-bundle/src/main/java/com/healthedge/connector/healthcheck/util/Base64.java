...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
    ...
    {
        return encodeObject( serializableObject, false );
    }   // end encodeObject
    ...
    public static String encodeObject( java.io.Serializable serializableObject, boolean breakLines )
    {
        ...
        finally
        {
            ...
            if(b64os != null) try { b64os.close(); } catch(Exception e) { e.printStackTrace(); }
    ...
    {
        return encodeBytes( source, false );
    }   // end encodeBytes
    ...
    public static void main(String[] args) {
        try {
            for(int i = 0; i < args.length; ++i) {
                ...
                String s = Base64.decodeToString(encoded);
                System.out.println("args: " + args[i]);
                System.out.println("encoded: " + encoded);
                System.out.println("after encoding/decoding: " + s);
                System.out.println("Same? " + args[i].equals(s));
            }
        }
        catch(Exception e) {
            e.printStackTrace();
